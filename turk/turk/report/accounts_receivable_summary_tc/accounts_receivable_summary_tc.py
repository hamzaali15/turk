...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def get_columns(self):
		...
		self.add_column(label=_("Territory"), fieldname='territory_turk', fieldtype='Link', options='Territory', width=150)
		self.add_column(label=_("Owner of SO"), fieldname='owner_so', fieldtype='Link', options='User', width=150)
		self.add_column(label=_("Cost Center"), fieldname='cost_center', fieldtype='Link', options='Cost Center', width=150)
